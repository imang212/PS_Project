...
from Input import VideoStream, VideoStreamListener, CameraOpenError, VideoStreamFormatterStrategy, CameraVideoProvider, YouTubeVideoProvider, PiCameraProvider
...
def main():
    ...
    video_provider = PiCameraProvider("imang", "imang", "192.168.37.205")
